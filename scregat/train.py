"""
Training and Testing Functions for SCReGAT

Contains functions for training, testing, and utility functions.
"""
...
from .model import EdgeDiversityLoss1
...
def get_edge_info_all(df_edges, dataset_atac):
...
def get_edge_info_with_anchor(dataset_atac, anchor_peaks):
    ...
    peak_list = [dataset_atac.array_peak[t] for t in peak_index]
    gene_list = [dataset_atac.array_peak[t] for t in gene_index]
    promoter_list = [anchor_peaks[t] for t in gene_list]
