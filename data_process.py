...
class ATACDataset(object):
    ...
    def add_promoter(self, file_tss: str, flank_proximal: int = 2000,if_NB_MYCN : bool = False):
    ...
    def build_graph(self, path_interaction: str, file_suffix: str, sel_interaction: str = 'PO'):
...
def prepare_model_input(adata_atac,
                        path_data_root: str, 
                        file_atac: str, 
                        ...
                        if_NB : bool = False,
                        deepen_data: bool = True, use_additional_tf=False, tissue_cuttof=3):
    ...
    dataset_ATAC = ATACDataset(adata_atac=adata_atac,
    ...
    dataset_ATAC.build_graph(path_hic, file_suffix=Hi_C_file_suffix, sel_interaction='ALL')
    ...
    path_tf2 = os.path.join(os.path.dirname(basepath), './data/TF_Gene_tissue_cutoff1.csv')
